...
class UserTest < ActiveSupport::TestCase
  ...
  test "email validation should accept valid address" do
    valid_addresses = %w[user@example.com USER@foo.COM A_US-ER@foo.bar.o first.last@foo.jp alice+bob@baz.cn]
  ...
  test "email validation should reject invalid address" do
    ...
    invalid_addresses.each do |invalid_addresses|
      ...
      assert @user.valid?, "#{invalid_addresses.inspect} should be invalid"
    end
  end
end
